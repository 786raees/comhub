...
urlpatterns = [
    ...
    path("customer_file_upload_page/<str:username>/<int:file_id>/", file_sharing_views.customer_file_upload_page, name="customer_file_upload_page"),
    path("delete_file/<int:file_id>/", file_sharing_views.delete_file, name="delete_file"),
